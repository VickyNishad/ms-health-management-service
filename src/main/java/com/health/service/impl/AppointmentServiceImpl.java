...
public class AppointmentServiceImpl implements AppointmentService {
	...
	@Override
	public ResponseEntity<ApiResponse<MessageResponse>> bookAppointment(Long userId,
